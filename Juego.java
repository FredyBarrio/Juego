...
public class Juego {
    ...
    static void atacar(personajes jugador1, personajes jugador2){
        ...
        jugador2.PS=jugador2.PS-Daño2;
            ...
            System.out.println ("resto de ps de jugador 2 es "+jugador2.Nombre+" Son " +jugador2.PS );          
            System.out.println("");
    }   
    static void atacar2(personajes jugador2, personajes jugador1){
        ...
        System.out.println (jugador1.Nombre+" del jugador 1 recibio "+Daño+" de daño"); 
        System.out.println("");
        System.out.println ("resto de ps de jugador 1 es "+jugador1.Nombre+ " son " +jugador1.PS ); 
        System.out.println("");
}
}
